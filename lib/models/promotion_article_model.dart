...
class PromotionArticleModel extends ArticleModel {
  static const String ContentType = 'promotion';
  ...
  factory PromotionArticleModel.fromMap(Map<String, dynamic> map) {
    return PromotionArticleModel(
      id: map['id'],
  ...
  factory PromotionArticleModel.fromDbMap(Map<String, dynamic> map) {
    return PromotionArticleModel(
      id: map['Id'],
      title: map['Title'],
      strippedContent: map['StrippedContent'],
